...
REAL_LLM_NOT_CONFIGURED = "REAL_LLM_NOT_CONFIGURED"
...
ERROR_MESSAGES = {
    ...
    EXTRACTOR_UNAVAILABLE: "Extractor backend is unavailable.",
    REAL_LLM_NOT_CONFIGURED: "Real LLM backend is not configured.",
...
ERROR_STATUS = {
    ...
    REAL_LLM_NOT_CONFIGURED: 503,
    GRAPH_RUN_FAILED: 500,
    REPLAY_FAILED: 500,
    EVAL_FAILED: 500,
    INTERNAL_ERROR: 500,
}
